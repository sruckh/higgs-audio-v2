    ...
    def _prepare_messages(self, transcript: str, ref_audio: str, scene_prompt: str) -> list:
        ...
        if ref_audio:
            ...
            if voice_path:
                ...
                ref_message = {
                    "role": "user", 
                    "content": f"[SPEAKER:{ref_audio}] {ref_text}"
                }
...
INPUT_SCHEMA = {
    ...
    'scene_prompt': {
        'type': 'string',
        'required': False,
        'default': 'quiet indoor setting with warm, friendly tone'
    },
    'temperature': {
        'type': 'number',
        'required': False,
    ...
    try:
        ...
        if 'errors' in validated_input:
            return {
                ...
                'details': validated_input['errors']
            }
