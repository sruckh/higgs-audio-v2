...
def test_text_to_speech():
    ...
    job = {
        "input": {
            ...
            "voice_id": "en_woman",
            "options": {"temperature": 0.7, "max_new_tokens": 1024},
        }
    }
...
def test_multi_speaker():
    ...
    job = {
        "input": {
            ...
            "options": {"temperature": 0.8, "max_new_tokens": 2048},
        }
    }
...
def test_scene_based():
    ...
    job = {
        "input": {
            ...
            "options": {"scene_id": "quiet_indoor", "temperature": 0.7, "max_new_tokens": 1024},
        }
    }
...
def test_experimental():
    ...
    job = {
        "input": {
            ...
            "options": {"experimental_type": "bgm", "temperature": 0.8, "max_new_tokens": 1024},
        }
    }
...
def test_invalid_input():
    ...
    job = {"input": {"text": "This should fail"}}
