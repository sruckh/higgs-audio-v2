    ...
    try:
        ...
        messages = [
            Message(role="system", content=[
                TextContent(text="You are an AI assistant designed to convert text into speech.")
            ]),
...
def handle_voice_cloning(text: str, voice_id: str, options: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        messages = [
            Message(role="system", content=[
                TextContent(text="You are an AI assistant designed to convert text into speech using the provided voice reference.")
            ]),
            Message(role="user", content=[
...
If no speaker tag is present, select a suitable voice on your own."""
        ...
        messages = [
            Message(role="system", content=[
                TextContent(text=system_message)
            ]),
            Message(role="user", content=[
                TextContent(text=text)
            ])
...
def handle_vllm(text: str, options: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        messages = [
            Message(role="system", content=[
                TextContent(text="You are an AI assistant designed to convert text into speech with high throughput.")
            ]),
            Message(role="user", content=[
                TextContent(text=text)
            ])
