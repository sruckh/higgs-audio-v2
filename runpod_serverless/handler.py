...
from .model_loader import get_memory_info, initialize_models, is_ready
from .monitoring import get_monitoring_dashboard, monitor_error, monitor_request
...
def validate_input(job_input: dict[str, Any]) -> tuple[bool, str]:
    ...
    valid_endpoints = ["text_to_speech", "voice_cloning", "multi_speaker", "vllm", "scene_based", "experimental"]
