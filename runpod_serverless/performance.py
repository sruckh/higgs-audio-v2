...
class PerformanceMonitor:
    ...
    def measure_performance(self, operation_name: str = "operation"):
        ...
        try:
            ...
            logger.info(f"  GPU memory: {gpu_memory_before:.2f}GB -> {gpu_memory_after:.2f}GB (peak: {gpu_memory_peak:.2f}GB)")
...
class PerformanceOptimizer:
    ...
    def get_optimization_recommendations(self) -> List[str]:
        ...
        if memory_percent > 90:
            recommendations.append("Critical: GPU memory usage > 90%. Consider reducing batch size or model parameters.")
